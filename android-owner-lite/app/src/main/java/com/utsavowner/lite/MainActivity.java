...
import com.utsavowner.lite.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    private static final String OWNER_APP_URL = "https://utsav-feed-application.onrender.com/owner-app/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                try {
                    ...
                    if (allowCamera) {
                        ...
                        capturedPhotoUri = FileProvider.getUriForFile(
                            MainActivity.this,
                            "com.utsavowner.lite.fileprovider",
                            photoFile
                        );
        ...
        if (savedInstanceState != null) {
            ...
            binding.webView.loadUrl(OWNER_APP_URL);
        }
    ...
    private File createImageFile() throws IOException {
        ...
        return File.createTempFile("utsav_owner_" + timeStamp, ".jpg", storageDir);
    }
